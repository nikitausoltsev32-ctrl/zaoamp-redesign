...
export const benefits: Benefit[] = [
  {
    ...
    description: 'Добыча белого мрамора на собственном месторождении в Челябинской области'
  },
  {
    id: '2',
    icon: Sparkles,
  ...
  },
  {
    id: '3',
    icon: Factory,
    title: '12 позиций в каталоге',
    description: 'Крошка, щебень, мраморная мука и микрокальцит для разных задач'
  },
  {
    id: '4',
    icon: Ruler,
  ...
  },
  {
    ...
    description: 'Согласовываем условия поставки, упаковку и документы под формат закупки'
  },
  {
    id: '8',
    icon: Package,
