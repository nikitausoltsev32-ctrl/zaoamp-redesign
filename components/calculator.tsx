      ...
      <CardContent className="space-y-6">
        ...
        {calculation && (
          <div className="space-y-4 pt-4 border-t">
            ...
            {/* Точный расчёт по телефону */}
            <div className="mt-6 pt-6 border-t border-stone-200">
              <div className="space-y-3 rounded-lg border border-brand-sapphire/20 bg-brand-ice-blue/50 p-4 text-center">
                <div>
                  <p className="font-semibold text-gray-900 text-sm">Нужен точный расчёт с учётом скидки на объём?</p>
                  <p className="text-xs text-muted-foreground">Позвоните менеджеру — подготовим коммерческое предложение.</p>
                </div>
