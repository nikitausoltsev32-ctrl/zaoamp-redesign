        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="bg-white text-gray-900 p-6 sm:p-8 rounded-2xl shadow-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="samples-cta-name" className="block text-sm font-medium text-gray-700 mb-1">Как к вам обращаться?</label>
                <Input 
                  id="samples-cta-name"
              ...
              <div>
                <label htmlFor="samples-cta-phone" className="block text-sm font-medium text-gray-700 mb-1">Телефон</label>
                <Input 
                  id="samples-cta-phone"
                  type="tel" 
              ...
              <div>
                <label htmlFor="samples-cta-city" className="block text-sm font-medium text-gray-700 mb-1">Город доставки</label>
                <Input 
                  id="samples-cta-city"
