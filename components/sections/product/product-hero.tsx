              ...
              >
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-[120px_1fr]">
                  <div className="space-y-1 text-sm">
                    <label htmlFor="order-quantity" className="text-muted-foreground block">Тонн</label>
                    <Input
                      id="order-quantity"
                      type="number"
                      min={1}
                  ...
                  <div className="space-y-1 text-sm">
                    <label htmlFor="order-packaging" className="text-muted-foreground block">Упаковка</label>
                    <select
                      id="order-packaging"
                      value={packaging}
                ...
                <div className="mt-3 block space-y-1 text-sm">
                  <label htmlFor="order-phone" className="text-muted-foreground block">Телефон для подтверждения</label>
                  <Input
                    id="order-phone"
                    type="tel"
