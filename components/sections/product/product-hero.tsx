            ...
            {typeof product.pricePerTon === 'number' && (
              ...
              >
                ...
                <div className="mt-4 grid gap-3 sm:grid-cols-[120px_1fr]">
                  <label htmlFor="product-hero-quantity" className="space-y-1 text-sm">
                    <span className="text-muted-foreground">Тонн</span>
                    <Input
                      id="product-hero-quantity"
                      type="number"
                      min={1}
                      step={1}
                      value={quantity}
                  ...
                  <label htmlFor="product-hero-packaging" className="space-y-1 text-sm">
                    <span className="text-muted-foreground">Упаковка</span>
                    <select
                      id="product-hero-packaging"
                      value={packaging}
                ...
                <label htmlFor="product-hero-phone" className="mt-3 block space-y-1 text-sm">
                  <span className="text-muted-foreground">Телефон для подтверждения</span>
                  <Input
                    id="product-hero-phone"
                    type="tel"
